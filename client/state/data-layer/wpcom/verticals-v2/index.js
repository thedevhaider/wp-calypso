...
import { VERTICALS_V2_REQUEST } from 'calypso/state/action-types';
...
import { setVerticals } from 'calypso/state/verticals-v2/actions';
...
registerHandlers( 'state/data-layer/wpcom/verticals-v2', {
	[ VERTICALS_V2_REQUEST ]: [
		( store, action ) =>
